...
var Ls = {
	...
	"deu": {
		...
		"hks": [
			[
				"Verschiedenes",
				["ESC", "verschiedene Dinge schließen"],

				"Dateimanager",
				["G", "Listen-/Rasteransicht umschalten"],
				["T", "Vorschaubilder/Icons umschalten"],
				["⇧ A/D", "Vorschaubildgrösse"],
				...
				"Dateiauswahl",
				["Leertaste", "Dateiauswahl umschalten"],
				["↑/↓", "Cursor bewegen"],
				["Strg ↑/↓", "Cursor und Ansicht verschieben"],
				["⇧ ↑/↓", "vorherige/nächste Datei auswählen"],
				["Strg-A", "alle Dateien/Ordner auswählen"],
			], [
				"Navigation",
				["B", "Brotkrümelnavigation/Navigationsleiste umschalten"],
				["I/K", "vorheriger/nächster Ordner"],
				["M", "übergeordneter Ordner (oder aktuellen einklappen)"],
				["V", "Ordner/Textdateien in Navigationsleiste umschalten"],
				["A/D", "Grösse der Navigationsleiste ändern"],
			], [
				"Audioplayer",
				["J/L", "vorheriger/nächster Song"],
				["U/O", "10 Sek. zurück/vor springen"],
				...
				["⇧ R", "gegen den Uhrzeigersinn drehen"],
				["S", "Bild auswählen"],
				["Y", "Bild herunterladen"],
			], [
				"Videoplayer",
				["U/O", "10 Sek. zurück/vor springen"],
				["P/K/Leertaste", "Wiedergabe/Pause"],
				["C", "mit nächster Datei fortfahren"],
				["V", "Wiederholungswiedergabe (Loop)"],
				["M", "Stummschalten"],
				["[ und ]", "Loop-Interval einstellen"],
			], [
				"Textdatei-Betrachter",
		...
		"ot_noie": 'Bitte Chrome / Firefox / Edge verwenden',

		"ab_mkdir": "Ordner erstellen",
		"ab_mkdoc": "neues Markdown Dokument",
		"ab_msg": "Nachricht an Serverlog senden",

		"ay_path": "zu Ordnern springen",
		"ay_files": "zu Dateien springen",

		"wt_ren": "ausgewählte Elemente umbenennen$Tastenkürzel: F2",
		"wt_del": "ausgewählte Elemente löschen$NTastenkürzel: Strg-K",
		"wt_cut": "ausgewählte Elemente ausschneiden &lt;small&gt;(um sie anderswo einzufügen)&lt;/small&gt;$NTastenkürzel: Strg-X",
		"wt_cpy": "ausgewählte Elemente in Zwischenablage kopieren$N(um sie anderswo einzufügen)$NTastenkürzel: Strg-C",
		"wt_pst": "zuvor ausgeschnittene/kopierte Elemente einfügen$NTastenkürzel: Strg-V",
		"wt_selall": "alle Dateien auswählen$NTastenkürzel: Strg-A (wenn Datei fokussiert)",
		"wt_selinv": "Auswahl umkehren",
		"wt_zip1": "diesen Ordner als Archiv herunterladen",
		"wt_selzip": "Auswahl als Archiv herunterladen",
		"wt_seldl": "Auswahl als separate Dateien herunterladen$NTastenkürzel: Y",
		"wt_npirc": "Titelinfo im IRC-Format kopieren",
		"wt_nptxt": "Titelinfo als Klartext kopieren",
		"wt_m3ua": "zu m3u-Wiedergabeliste hinzufügen (klicke <code>📻copy</code> später)",
		"wt_m3uc": "m3u-Wiedergabeliste in Zwischenablage kopieren",
		"wt_grid": "Raster-/Listenansicht umschalten$NTastenkürzel: G",
		"wt_prev": "vorheriger Titel$NTastenkürzel: J",
		"wt_play": "abspielen/pausieren$NTastenkürzel: P",
		"wt_next": "nächster Titel$NTastenkürzel: L",

		"ul_par": "parallele Uploads:",
		"ut_rand": "Dateinamen zufällig generieren",
		"ut_u2ts": "Zuletzt geändert-Zeitstempel von$Ndeinem Dateisystem auf den Server übertragen\">📅",
		"ut_ow": "Existierende Dateien auf dem Server überschreiben?$N🛡️: Nie (generiert stattdessen neuen Dateinamen)$N🕒: Überschreiben, wenn Server-Datei älter als meine ist$N♻️: Überschreiben, wenn der Dateiinhalt anders ist",
		"ut_mt": "Andere Dateien während des Uploads hashen$N$Nsolltest du deaktivieren, falls deine CPU oder$NFestplatte zum Flaschenhals werden könnte",
		"ut_ask": 'Vor dem Upload Bestätigung anfordern">💭',
		"ut_pot": "Verbessert die Leistung schwacher Geräte$Nindem die Benutzeroberfläche vereinfacht wird",
		"ut_srch": "nicht wirklich hochladen, stattdessen prüfen ob Dateien$Nbereits auf dem Server existieren (scannt alle lesbare Ordner)",
		"ut_par": "auf 0 setzen, um das Hochladen vorübergehend zu stoppen, höhere Werte (4 oder 8) können zu einer besseren Leistung führen, insbesondere bei langsamer/instabiler Internetverbindung, sollte im LAN oder bei einer langsamen Festplatte des Servers nicht höher als 1 sein",
		"ul_btn": "Dateien/Ordner hier<br>ablegen (oder mich klicken)",
		"ul_btnu": "H O C H L A D E N",
		"ul_btns": "S U C H E N",

		"ul_hash": "hash",
		"ul_send": "senden",
		"ul_done": "fertig",
		"ul_idle1": "keine Uploads in Warteschlange",
		"ut_etah": "durchschnittliche &lt;em&gt;Hash&lt;/em&gt;-Geschwindigkeit und geschätzte Restzeit",
		"ut_etau": "durchschnittliche &lt;em&gt;Upload&lt;/em&gt;-Geschwindigkeit und geschätzte Restzeit",
		"ut_etat": "durchschnittliche &lt;em&gt;Gesamt&lt;/em&gt;-Geschwindigkeit und geschätzte Restzeit",

		"uct_ok": "erfolgreich abgeschlossen",
		"uct_ng": "fehlgeschlagen/abgelehnt/nicht gefunden",
		...
		"u_nav_m": '<h6>okay, was gibts??</h6><code>Eingabe</code> = Dateien (eine oder mehrere)\n<code>ESC</code> = Ein Ordner (inkl. Unterordner)',
		"u_nav_b": '<a href="#" id="modal-ok">Dateien</a><a href="#" id="modal-ng">Ein Ordner</a>',
		...
		"ct_ttips": '(╭ರ_•́)">ℹ️ Tooltips',
		"ct_thumb": 'in Rasteransicht, zwischen Icons und Vorschaubilder wechseln$NTastenkürzel: T">🖼️ Vorschaubilder',
		"ct_csel": 'in Rasteransicht Strg und Umschalt für Dateiauswahl verwenden">sel',
		"ct_ihop": 'bei Schließen des Bildbetrachters zur zuletzt betrachteter Datei scrollen">g⮯',
		"ct_dots": 'verstecke Dateien anzeigen (falls durch Server erlaubt)">dotfiles',
		"ct_qdel": 'beim Löschen nur einmal nach Bestätigung fragen">qdel',
		...
		"tt_entree": "Navigationsleiste (Ordnerbaum-Sidebar) anzeigen$NTastenkürzel: B",
		"tt_detree": "Brotkrümelnavigation anzeigen$NTastenkürzel: B",
		"tt_visdir": "zum ausgewählten Ordner scrollen",
		"tt_ftree": "Ordnerbaum/Textdateien umschalten$NTastenkürzel: V",
		"tt_pdock": "übergeordnete Ordner in angedocktem Bereich oben anzeigen",
		"tt_dynt": "automatisch wachsen, wenn Baum sich ausdehnt",
		...
		"mt_one": "nach einem Titel stoppen\">1️⃣",
		"mt_shuf": "Zufällige Wiedergabe im Ordner\">🔀",
		"mt_aplay": "automatisch abspielen, wenn der Link, mit dem Sie auf den Server zugreifen, eine Titel-ID enthält$N$NDeaktivieren verhindert auch, dass die Seiten-URL bei Musikwiedergabe mit Titel-IDs aktualisiert wird, um Autoplay zu verhindern, falls diese Einstellungen verloren gehen, die URL aber bestehen bleibt\">a▶",
		...
		"mt_uncache": "Cache leeren &nbsp;(versuchen Sie dies, wenn Ihr Browser$Neine defekte Kopie eines Titels zwischenspeichert und sich weigert, ihn abzuspielen)\">Cache leeren",
		"mt_mloop": "offenen Ordner wiederholen\">🔁 Schleife",
		"mt_mnext": "nächsten Ordner laden und fortfahren\">📂 nächster",
		"mt_mstop": "Wiedergabe stoppen\">⏸ Stop",
		"mt_cflac": "flac / wav zu opus konvertieren\">flac",
		"mt_caac": "aac / m4a zu opus konvertieren\">aac",
		"mt_coth": "alle anderen (nicht mp3) zu opus konvertieren\">andere",
		...
		"mt_c2mp3": "auf sehr alten Geräten verwenden\">mp3",
		"mt_c2ok": "gute Wahl!",
		...
		"mm_edec": "Diese Datei ist anscheinend beschädigt??",
		...
		"mm_e5xx": "Konnte Datei nicht abspielen; Serverfehler ",
		...
		"f_chide": 'dies blendet die Spalte «{0}» aus\n\nSie können Spalten in den Einstellungen wieder einblenden',
		"f_bigtxt": "diese Datei ist {0} MiB groß -- wirklich als Text anzeigen?",
		"f_bigtxt2": "stattdessen nur das Ende der Datei anzeigen? Dies aktiviert auch das Folgen/Verfolgen, das neu hinzugefügte Textzeilen in Echtzeit anzeigt",
		...
		"f_partial": "Um eine aktuell hochgeladene Datei sicher herunterzuladen, klicken Sie auf die Datei mit demselben Namen, aber ohne die <code>.PARTIAL</code>-Erweiterung. Bitte drücken Sie ABBRECHEN oder Escape, um dies zu tun.\n\nOK/Enter drücken ignoriert diese Warnung und lädt stattdessen die <code>.PARTIAL</code>-Zwischendatei herunter, was fast sicher beschädigte Daten liefert.",

		"ft_paste": "{0} Elemente einfügen$NTastenkürzel: Strg-V",
		"fr_eperm": 'kann nicht umbenennen:\nSie haben keine "Verschieben"-Berechtigung in diesem Ordner',
		"fd_eperm": 'kann nicht löschen:\nSie haben keine "Löschen"-Berechtigung in diesem Ordner',
		"fc_eperm": 'kann nicht ausschneiden:\nSie haben keine "Verschieben"-Berechtigung in diesem Ordner',
		"fp_eperm": 'kann nicht einfügen:\nSie haben keine "Schreiben"-Berechtigung in diesem Ordner',
		"fr_emore": "mindestens ein Element zum Umbenennen auswählen",
		"fd_emore": "mindestens ein Element zum Löschen auswählen",
		"fc_emore": "mindestens ein Element zum Ausschneiden auswählen",
		"fcp_emore": "mindestens ein Element zum Kopieren in die Zwischenablage auswählen",

		"fs_sc": "aktuellen Ordner teilen",
		"fs_ss": "ausgewählte Dateien teilen",
		"fs_just1d": "Sie können nicht mehr als einen Ordner auswählen$Noder Dateien und Ordner in einer Auswahl mischen",
		"fs_abrt": "❌ abbrechen",
		"fs_rand": "🎲 Zufallsname",
		...
		"frt_dec": "kann einige Fälle kaputter Dateinamen beheben\">url-decode",
		"frt_rst": "geänderte Dateinamen auf Originale zurücksetzen\">↺ zurücksetzen",
		"frt_abrt": "abbrechen und dieses Fenster schließen\">❌ abbrechen",
		"frb_apply": "ÜBERNEHMEN",
		"fr_adv": "Stapel-/Metadaten-/Musterumbenennung\">erweitert",
		"fr_case": "Groß-/Kleinschreibung beachten\">Großschreibung",
		"fr_win": "Windows-kompatible Namen; ersetze <code>&lt;&gt;:&quot;\\|?*</code> durch japanische Fullwidth-Zeichen\">win",
		"fr_slash": "ersetze <code>/</code> durch ein Zeichen, das keine neuen Ordner erstellt\">kein /",
